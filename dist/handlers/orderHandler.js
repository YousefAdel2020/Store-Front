...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, status_1, user_id, order, error_1;
...
var current_order = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id, cur, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var orderRoutes = function (app) {
    ...
    app.get('/orders/users/:id', auth_1.verifyAuthToken, current_order);
};

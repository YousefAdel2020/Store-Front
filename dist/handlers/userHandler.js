...
// make interface to make request type accept user property
...
var show = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, info.show(parseInt(_req.params.id))];
            case 1:
                user = _a.sent();
...
var destroy = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, info.delete(_req.params.id)];
            case 1:
                deleted = _a.sent();
